  ...
  return (
    <div className="mt-[120px] px-[20px]">
      <footer class="mt-10 w-full ">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10 mt-10">
          ...
          <div>
            ...
            <div class="mt-3 grid space-y-3 text-sm">
              ...
              <p>
                <a
                  class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                  href="https://drive.google.com/uc?id=1WXk6h7JByY0Wzkw2jyDz9SV0JkLnY3bb&export=download"
                >
                  Download Brochure
                </a>
              </p>
          ...
          <div>
            ...
            <div class="mt-3 grid space-y-3 text-sm">
              ...
              {/* <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="/feed">Newsroom</a></p> */}
            </div>
          </div>
          <div>
            <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">
            ...
            <div class="flex flex-wrap justify-between items-center gap-3">
              ...
              <div class="space-x-4">
                <a
                  ...
                  href="https://www.linkedin.com/in/shreen-chand-7286a1145/"
                >
                  <svg
                ...
                <a
                  class="inline-block text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                  href="https://www.instagram.com/shreenchand?igsh=MW85b2oyOTA5OWkx"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
