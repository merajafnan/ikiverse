...
export const GoogleGeminiEffect = ({
    ...
    return (
        (<div className={cn("sticky top-80", className)}>
            <p
                className="text-lg md:text-7xl font-bold pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
                {title || `Contact us`}
            </p>
            <p
            ...
            <div
                ...
                <button
                    className="font-bold bg-gray-100 rounded-full md:px-7 md:py-3 px-2 py-1 md:mt-24 mt-8 z-30 md:text-xl text-black text-xs w-fit mx-auto " >
                    <a href="/contactUsFormPage">Click to fill the form</a>
                </button>
            </div>
            <svg
                width="1440"
