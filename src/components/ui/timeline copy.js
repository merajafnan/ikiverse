    ...
    return (
        (<div
            ...
            <div className="max-w-7xl mx-auto pt-10 px-4 md:px-8 lg:px-10">
                ...
                That's how simple it is to request educational from IkiTech.
                </h2> */}
                <h1 class="text-3xl lg:text-7xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">That's how simple it is to <span class="bg-gradient-to-r from-cyan-400 to-indigo-600 bg-clip-text text-transparent">request services</span> from IkiVerse.</h1>
                {/* <p
