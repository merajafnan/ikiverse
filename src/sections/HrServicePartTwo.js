...
export function HrServicePartTwo() {
  const features = [
    {
      title: "Recruitment and Staffing",
      description:
        "Finding, interviewing, and hiring the right candidates for various roles within an organization.",
    ...
    {
      title: "Watch our YouTube video for Career Guidance",
      description:
        "Navigate your career with confidence. Let us guide you to the path that leads to success.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
    },
    {
      title: "Discover Our Hub—Where Your Journey Begins!",
      description:
        "Our Office: Bangalore / Ranchi / Jamshedpur / Patna",
    ...
    (<div className="relative  py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <h4
          ...
          Your one-stop solution for all HR <span className="bg-gradient-to-r from-cyan-400 to-indigo-600 bg-clip-text text-transparent">Services</span>
        </h4>

        <p
          className="text-xl max-w-3xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          Choosing the ideal candidate for your company is a vital process that depends on how you identify, evaluate, and interview prospective candidates. Our tailored solutions help you secure top talent swiftly. 
        </p>
      </div>
