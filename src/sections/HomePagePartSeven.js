...
export function HomePagePartSeven() {
  return (
    (<div
      className="h-[30rem] rounded-md flex flex-col antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
            ...
            <h1 class="flex items-center justify-center block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              What our client <span class="bg-gradient-to-r from-cyan-400 to-indigo-600 bg-clip-text text-transparent" style={{ marginLeft: "15px", marginRight: "15px"}}> say </span>about us
            </h1>
            <div>
              <div class="w-2/3 sm:w-1/2 lg:w-1/2 mx-auto text-center pt-5 pb-5">
