...
const FormSubmitIO = () => {
    ...
    return (
        <div className='sm:grid lg:flex lg:items-center lg:justify-center lg:h-screen lg:gap-10'>

            <div className='flex item-center justify-center lg:text-left text-center py-20'>
                <div>
