...
export function AboutUsPartThree() {
  return (
    (
      <div>
        <div className="mb-10">
          <div class="flex items-center justify-center mb-10">
            <h2 className="text-2xl lg:text-7xl text-gray-800 font-bold sm:text-3xl dark:text-neutral-200">
              Our Expertise
            </h2>
          </div>
          </div>
  ...
  const variants = {
        ...
        (<motion.div
          ...
          <motion.div
            ...
            <img src="/aboutUs/as_webdev_5.jpg" className="h-full w-full rounded-xl" alt="" />
          </motion.div>
        </motion.div>)
        );
};
  ...
  const first = {
        ...
        (<motion.div
          ...
          <motion.div
            ...
            className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
            <Image
              src="/aboutUs/as_webdevelopment.png"
              alt="avatar"
              height="100"
              width="100"
              className="h-10 w-10" />
...
const SkeletonFive = () => {
  const variants = {
        ...
        (<motion.div
          ...
          <motion.div
            variants={variants}
            className="flex flex-row rounded-2xl border border-neutral-100 dark:border-white/[0.2] p-2  items-start space-x-2 bg-white dark:bg-black">
            <img src="/aboutUs/as_hr_service_1.jpg" className="h-full w-full rounded-xl" alt="" />
          </motion.div>
        </motion.div>)
        );
};
        ...
        description: (
        <span className="text-sm">
          Designing intuitive interfaces and unforgettable user experiences.
        </span>
        ),
        header: <SkeletonOne />,
        className: "md:col-span-1",
        ...
        description: (
        <span className="text-sm">
          Ease your lengthy hiring process with IkiVerse.
        </span>
        ),
        header: <SkeletonFive />,
        className: "md:col-span-1",
  ...
  // {
          ...
          // },
          {
            ...
            description: (
              <span className="text-sm">
                Multi-Domain educatinal training by top industrial candidates.
              </span>
            ),
            header: <SkeletonFour />,
          ...
          },
          {
            ...
            description: (
              <span className="text-sm">
                Empowering your vision with expert guidance for startup success.
              </span>
            ),
            header: <SkeletonTwo />,
            className: "md:col-span-1",
